...
// RP2350-One uses WS2812 on GPIO 16
#define RP2350_ONE_LED_PIN 16

void led_driver_init_rp2350_one() {
    PIO pio = pio0;
    int sm = 0;
    uint offset = pio_add_program(pio, &ws2812_program);
    uint8_t gpio = RP2350_ONE_LED_PIN;
...
// RP2350-One WS2812 data ordering - try RGB
...
void led_driver_color_rp2350_one(uint8_t color, uint32_t led_brightness, float progress) {
...
led_driver_t led_driver_rp2350_one = {
    .init = led_driver_init_rp2350_one,
    .set_color = led_driver_color_rp2350_one,
};
